		...
		<div class="container">
			...
			<div class="c-navbar-wrapper clearfix">
				<div class="c-brand c-pull-left">
					<a href="/" class="c-logo">
						<img src="{{asset('/assets/base/img/layout/logos/family fun.jpg')}}" alt="JANGO" class="c-desktop-logo">
						<img src="{{asset('/assets/base/img/layout/logos/family fun.jpg')}}" alt="JANGO" class="c-desktop-logo-inverse">
						<img src="{{asset('/assets/base/img/layout/logos/family fun.jpg')}}" alt="JANGO" class="c-mobile-logo">
					</a>
