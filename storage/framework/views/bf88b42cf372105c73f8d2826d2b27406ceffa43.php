            ...
            <div class="row">
                <div class="col-sm-6 wow animated fadeInLeft">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-10">
                            <p class="lead">
                                <span class="alternative-font">Family Fun</span>
                            </p>
                            <p style="font-size:16px">The first in Kuwait and the Middle East to display the activities of clubs for men, women, children
                                and nurseries.Provides announcement of the private channel for free.
                            </p>
                        </div>
